...
public class TestBlock extends BettermineplusModElements.ModElement {
	@ObjectHolder("bettermineplus:test")
	public static final Block block = null;
	public TestBlock(BettermineplusModElements instance) {
		super(instance, 7);
	}
