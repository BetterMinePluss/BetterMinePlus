...
package net.mcreator.bettermineplus.world.biome;
...
import net.mcreator.bettermineplus.block.SousSolMortBlock;
import net.mcreator.bettermineplus.block.SolMortBlock;
import net.mcreator.bettermineplus.block.BrancheBlock;
...
public class AbimeDesMortsBiome extends BettermineplusModElements.ModElement {
	public static Biome biome;
	public AbimeDesMortsBiome(BettermineplusModElements instance) {
		super(instance, 1);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(10387789).withGrassColor(-14076104).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(SolMortBlock.block.getDefaultState(),
								SousSolMortBlock.block.getDefaultState(), SousSolMortBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.BONE_BLOCK.getDefaultState()),
								new SimpleBlockStateProvider(BrancheBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("bettermineplus:abime_des_morts"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("abime_des_morts_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("abime_des_morts_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("abime_des_morts_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
